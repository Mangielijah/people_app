...
class _$_Person extends _Person {
  ...
  @override
  String toString() {
    return 'Person(id: $id, name: $name, profile_path: $profile_path, popularity: $popularity, biography: $biography, gender: $gender, birthday: $birthday, known_for_department: $known_for_department, deathday: $deathday, also_known_as: $also_known_as)';
  }
...
abstract class _Person extends Person {
  factory _Person(
      ...
      final String? known_for_department,
      final String? deathday,
      final List<String>? also_known_as}) = _$_Person;
  _Person._() : super._();
